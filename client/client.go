...
func ProtectCCFileKey(protectedCCKey []byte, fileKey []byte) (protectedCCFileKey []byte, err error) {

}
func ProtectCCFileStruct(protectedCCKey []byte, fileKey []byte) (protectedCCFileKey []byte, err error) {
